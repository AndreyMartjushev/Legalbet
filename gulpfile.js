...
gulp.task('build', gulp.series('clean:build', gulp.parallel('css:build', 'js:build','js-vendors:build', 'html:build', 'static:build', 'img:build', 'fonts:build')));
...
gulp.task('watch', () => {
	...
	gulp.watch('src/**/*.pug', gulp.parallel('pages'));
	gulp.watch('src/img/_src/**/*', gulp.parallel('img'));
});

gulp.task('start', gulp.parallel('pages','img', 'styles', 'scripts', 'browser-sync', 'watch'));